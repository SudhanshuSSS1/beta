    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <section className="max-w-7xl mx-auto px-6 py-16 text-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
          {/* Intern Card */}
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col">
            ...
            <ul className="text-left space-y-2 mb-8 text-sm flex-grow">
            ...
            <div className="mt-auto space-y-3">
              ...
              <Link
                to="/intern"
                className="block w-full bg-white text-blue-600 border border-blue-600 py-2.5 rounded-lg hover:bg-blue-50 transition-colors text-sm font-medium"
              >
                Login
              </Link>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col">
            ...
            <div className="mt-auto space-y-3">
              ...
              <Link
                to="/mentor"
                className="block w-full bg-white text-purple-600 border border-purple-600 py-2.5 rounded-lg hover:bg-purple-50 transition-colors text-sm font-medium"
              >
                Login
              </Link>
            </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col">
            ...
            <div className="mt-auto space-y-3">
              ...
              {/* Invisible placeholder to align with Login buttons of other cards */}
              <div className="py-2.5 border border-transparent select-none pointer-events-none opacity-0 text-sm font-medium">
                Placeholder
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6 border border-gray-100 hover:shadow-xl transition-all duration-300 flex flex-col">
            ...
            <div className="mt-auto space-y-3">
              ...
              <Link
                to="/company"
                className="block w-full bg-white text-emerald-600 border border-emerald-600 py-2.5 rounded-lg hover:bg-emerald-50 transition-colors text-sm font-medium"
              >
                Login
              </Link>
            </div>
